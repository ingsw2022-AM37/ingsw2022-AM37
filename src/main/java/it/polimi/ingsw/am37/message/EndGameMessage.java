...
public class EndGameMessage extends Message {
     ...
     * @param winnerUID      the uuid of the winner
     * @param winnerNickname the nickname of the winner
     */
    public EndGameMessage(String UUID, String winnerUID, String winnerNickname) {
     ...
     * @param winnerNickname the nickname of the winner
     */
    public EndGameMessage(String winnerUID, String winnerNickname) {
